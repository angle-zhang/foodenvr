---
title: "5_compare_measures"
author: "Angela Zhang"
date: "2025-04-02"
output: html_document
---
# Section E: Comparing food environment measures at different spatial scales
# Calculates summary statistics by census tract across population representation methods:
#   - CV: amount of variation within tracts (scaled by mean)
#   - Bias (mean difference): Mean(First method – Second method); systematic error (directional)
#   - MAE: Mean(|First method – Second method|); typical absolute disagreement
#   - RMSE: similar to MAE but weighs larger errors more
# Compares food environment measures produced using census tract centroids,
# population-weighted centroids, and parcel centroids.
...
# #'* Data frame with parcel means of food environment measures only *
...
```{r}
tm_shape(parcel_data_ct %>% drop_na(driving_SMK_20_parcel_cv)) + 
